...
| **A3.9 Vision** | Classical features; pretrained CNN/ViT; YOLO-style detection; U-Net/mask segmentation | Duplicate/subject leakage, annotations, imbalance, object size, camera shift, edge latency | CIFAR-10, Oxford Pet, COCO subset → error gallery, exported model, review path |
