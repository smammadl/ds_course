...
| Utility | Description |
|------|-------------|
| `s6.values` | Returns the values of the `Series` as a NumPy array. |
| `list(s6)` | Returns the values of the `Series` as a list. |
| `s6.index` | Returns the index of the `Series`. |
| `s6.shape` | Returns the shape of the `Series` (tuple of the form (length,)). |
| `len(s6)` | Returns the length of the `Series` (int). |
| `'bob' in s6` | Checks if 'bob' is in the `Series` index. |
| `s6.isnull()` | Returns a `Series` of booleans indicating if a value is missing. |
| `s6.notnull()` | Returns a `Series` of booleans indicating if a value is not missing. |
